...
## 🛠️ 주요 기술 스택
- **Spring Boot**: 전체 API 및 비즈니스 로직 구성
- **Spring Security + JWT**: 인증/인가 및 Oauth2 로그인
- **Spring Data JPA**: ORM 기반 DB 접근
- **Kafka + WebSocket**: 실시간 시세 스트리밍 처리
- **Redis**: 캐시, 세션, 실시간 알림 상태 저장소로 활용
- **MySQL**: 메인 데이터 저장소
- **Docker + AWS EC2/RDS**: 컨테이너 기반 배포
- **Swagger**: API 문서 자동 생성
- **JUnit5, Mockito**: 테스트 자동화
...
## 🖥️ 배포 링크
- 웹사이트: [https://utong.site](https://utong.site)
